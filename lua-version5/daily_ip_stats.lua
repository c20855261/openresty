-- daily_ip_stats.lua (v3.4.3 完整修正版)
-- 功能：顯示 daily ip stats，管理 whitelist/ban，支援 geo_mapping 中文顯示（fallback ip-api）
-- v3.4.3 變更：修正所有語法錯誤，顯示所有 ban keys 並標記格式錯誤的
